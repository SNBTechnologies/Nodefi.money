...
export default function Farming ({
  ...
  function farmsList () {
                ...
                <FarmListCont>
                  ...
                  <FarmInfo>
                    <div className="item">
                      ...
                      <span className="right">GATE</span>
                    </div>
                    <div className="item">
    ...
    //  <span className="right">{item} - {config.getCurChainInfo(CHAINID).symbol} {stakeType}</span> REPLACE line 658
    return (
      <>
        <FarmListBox>
          {
...
//     <span className="right">{item && item.tokenObj && item.tokenObj.symbol ? item.tokenObj.symbol : ''} {stakeType}</span> replace line 711
