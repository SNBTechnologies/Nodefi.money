  ...
  return (
    <>
      <HeaderLinks>
        ...
        <StyledNavLink id={`buybacks-nav-link`} to={'/buybacks'}>
          <div className="icon">
      ...
      <OutLink>
        <OutLinkImgBox>
          <Link id="link" href="https://t.me/olympusgate">
            <div className="icon">
          ...
          <Link id="link" href="https://twitter.com/olympusgate">
            <div className="icon">
        ...
        <CopyRightBox>
          <h5>
            Powered by <span>SNB Technologies</span>
          </h5>
          <p>© 2021 Olympus Gate. All rights reserved.</p>
        </CopyRightBox>
      </OutLink>
    </>
  )
