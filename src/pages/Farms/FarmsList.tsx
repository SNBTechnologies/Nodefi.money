    ...
    return [
      {
        ...
        info: (t('StakingTip', {symbol: 'GATE'}) + "<span class='pecent'>" + (BSCPTLKXStakingAPY ? (Number(BSCPTLKXStakingAPY)).toFixed(2) : '0.00') + "%</span>"),
      ...
      },
      {
        ...
        info: (t('StakingTip', {symbol: 'GATE'}) + "<span class='pecent'>" + (BSCKABYStakingAPY ? (Number(BSCKABYStakingAPY)).toFixed(2) : '0.00') + "%</span>"),
      ...
      },
      {
        ...
        url: '/farm/bsc/bacon',
        title: 'BACON Staking',
        info: (t('StakingTip', {symbol: 'GATE'}) + "<span class='pecent'>" + (BSCBACONStakingAPY ? (Number(BSCBACONStakingAPY)).toFixed(2) : '0.00') + "%</span>"),
      ...
      },
      {
        ...
        title: 'PLAY Staking',
        info: (t('StakingTip', {symbol: 'GATE'}) + "<span class='pecent'>" + (BSCPLAYStakingAPY ? (Number(BSCPLAYStakingAPY)).toFixed(2) : '0.00') + "%</span>"),
      ...
      },
      {
        ...
        url: '/farm/bsc/hero',
        title: 'HERO Staking',
        info: (t('StakingTip', {symbol: 'GATE'}) + "<span class='pecent'>" + (BSCHEROStakingAPY ? (Number(BSCHEROStakingAPY)).toFixed(2) : '0.00') + "%</span>"),
      ...
      },
      {
        ...
        url: 'farm/bsc',
        title: 'DEP Staking',
        info: (t('StakingTip', {symbol: 'GATE'}) + "<span class='pecent'>" + (BSCStakingAPY ? (Number(BSCStakingAPY)).toFixed(2) : '0.00') + "%</span>"),
        coin1: 'DEP',
        coin2: 'BNB',
        coin3: '',
      ...
      },
      {
        ...
        url: '/farm/bsc/tro',
        title: 'TRO Staking',
        info: (t('StakingTip', {symbol: 'GATE'}) + "<span class='pecent'>" + (BSCTROStakingAPY ? (Number(BSCTROStakingAPY)).toFixed(2) : '0.00') + "%</span>"),
        coin1: 'TRO',
        coin2: 'BNB',
        coin3: '',
